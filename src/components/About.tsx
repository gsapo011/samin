  ...
  return (
    ...
    <section id="about-me" className="about-section">
      ...
      <p>
        ...
        <a href="mailto:samipoyhonen88@email.com" className="mini-btn"><MdEmail />Email</a> |{" "}
        <a href="https://github.com/gsapo011" className="mini-btn"><FaGithub /> GitHub</a> |{" "}
        <a href="https://www.linkedin.com/in/sami-pöyhönen/" className="mini-btn"><FaLinkedin />LinkedIn</a>
      </p>
    </section>
  );
}